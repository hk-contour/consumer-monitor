...
**What it means:** The "Your Privacy Choices" footer link was removed from the Instacart Plus pricing page. This is routine maintenance (link removal/footer cleanup) with no material business impact.
...
### Investor Relations — change detected
**What it means:** Chewy updated its product catalog size from approximately 130,000 to 190,000 offerings on its investor relations corporate overview page, a 46% increase that represents a material product expansion disclosure. This is routine periodic updating of operating metrics rather than a pricing, rate, or structural change.

**Detail:**
  − Launched in 2011, we offer the personalized service of a neighborhood pet store alongside the convenience and speed of e-commerce. Customers love shopping our wide selection of approximately 130,000 p
...
### Newsroom — change detected
**What it means:** DoorDash's newsroom added three new announcements dated May 28, 2026 (Dollar Tree partnership, DashPass FIFA World Cup promotion, and international FIFA campaign), while removing older articles from May 22, 20, and 18, 2026. This appears routine—a standard newsroom feed refresh with dated content cycling out and new partnership/marketing announcements cycling in.

**Detail:**
  − Fremont Students Get Hands-On STEM Learning Experience Thanks to DoorDash
  − The Office of Fremont Mayor Salwan awarded certificates to students who completed the STEM education program, a partnership between Fremont Unified School District and DoorDash, that brought cutting-e
  − Icon Loading
  − May 22, 2026
  − Read more
  − Icon Loading
...
### Terms — change detected
**What it means:** The PDF document structure was recompiled and recompressed; the underlying content remained functionally identical but the file's internal object stream length decreased from 4324 to a smaller value, indicating a routine re-encoding/optimization of the PDF rather than a material terms change. This is a routine technical modification with no substantive policy or disclosure changes.
...
### Pricing — change detected
**What it means:** The pricing page section heading changed from "Robinhood Agentic Trading" to "Agentic trading and cards," suggesting the company is bundling or repositioning its AI trading feature alongside a cards product offering. This appears routine (section rename/reorganization) rather than a material pricing or product change, though the addition of "cards" warrants monitoring for potential new offerings.
...
### Pricing — change detected
**What it means:** Shopify reduced the earnings rate on Shopify Balance from 2.28% to 0.00% across three tier levels, which is a material change to a core financial product offering. This appears to be a downward revision to advertised returns rather than a routine update.
